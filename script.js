...
var a = document.getElementById("semifinal1");
...
var randomImage = new Array();
	...
	randomImage[0] = "images/finger-0.jpg";
	randomImage[1] = "images/can-1.jpg";
	randomImage[2] = "images/demon-2.jpg";
	randomImage[3] = "images/monster-3.jpg";
	randomImage[4] = "images/face-4.jpg";
	randomImage[5] = "images/foot-5.jpg";
	randomImage[6] = "images/jason-6.jpg";
	randomImage[7] = "images/slappy-7.jpg";
...
// First Section
function optionOne(){
	div = document.getElementById("semifinal1");
	img = div.childNodes[0];
	
	img_name_length = img.src.length;
	img_number = img.src.slice(img_name_length - 1, img_name_length);
	print(img_number);
	
	doSpecialEffect(img_number);
...
function doSpecialEffect(imgID) {
	switch (imgID) {
		case 1:
			print("image 0");
			break;
...
//a.getElementById("finger").src; //this did not work
